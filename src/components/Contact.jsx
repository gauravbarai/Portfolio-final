        ...
        <div className='contact' id='contact'>
            ...
            <div className="contactDiv">
                ...
                <div className="contactInfo swipe-fade-right1">
                    ...
                    <a href="https://www.instagram.com/_gauravbarai/"><p className='social'><AiOutlineInstagram />_gauravbarai</p></a>
                    <a href="https://linktr.ee/gauravbarai"> <p className='social'><SiLinktree />/gauravbarai</p></a>
